...
formattedList += `- <b>Т-Банк: Павел С.</b>\n`;
...
formattedList += `\n📜 <b>Информация для игроков:</b>\n` +
  ...
  `- <b>Выйти:</b> Напишите "-"\n` +
  `- <b>Уведомления:</b> Нажмите "Start" в <a href="t.me/football_ramen_bot">личке у бота</a>, чтобы получать уведомления и писать ему команды. Вы получите напоминание за 3 часа до матча и уведомление о переходе из очереди в основной список или обратно.\n`;
