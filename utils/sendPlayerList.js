...
const sendPlayerList = async (ctx, chatId = null) => {
  ...
  formattedList += `💸 <b>Оплатить Т-Банк:</b>\n`;
  formattedList += `<code>📲 89166986185</code>\n`;
  formattedList += `<code>💳 2200700430851708</code>\n`;
  formattedList += `💵 Nаличные — На месте\n`;
  formattedList +=
    `\n📜 <b>Информация для игроков:</b>\n` +
    `- <b>Записаться:</b> Напишите "+" или нажмите "⚽ Играть"\n` +
    `- <b>Выйти:</b> Напишите "-"\n` +
    `- <b>Уведомления:</b> Нажмите "Start" в <a href="t.me/football_ramen_bot">ЛС у бота</a>, чтобы получать уведомления и писать ему команды. Вы получите напоминание за 3 часа до матча и уведомление о переходе из очереди в основной список или обратно.\n`;
